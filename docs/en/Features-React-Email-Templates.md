...
You can grant or revoke these permissions per role from the [Role Management](Features-React-Role-Management.md) page.

## Next

- [Tenant Dashboard](Features-React-Tenant-Dashboard.md)
