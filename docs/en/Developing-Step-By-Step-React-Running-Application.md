...
<img src="images/login-as-host-react.png" alt="Login as host" class="img-thumbnail" style="width:100.0%" />

After login, we see the **tenant list** which only contains a
**default** tenant. We can create a new tenant:

<img src="images/create-tenant-react.png" alt="Creating tenant" class="img-thumbnail" />
...
<img src="images/phonebook-empty-react.png" alt="Empty phonebook of new tenant" class="img-thumbnail" />
...
- [Conclusion](Developing-Step-By-Step-React-Conclusion)