...
* ```PreventNotExistingTenantSubdomains``` to `true` in AppConsts.ts for React application.
...
<img src="images/ng2-modules.png" alt="React modules" class="img-thumbnail" width="501" height="221" />
