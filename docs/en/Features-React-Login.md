...
Default route for the account pages is the login page:
...
After login, we are redirected to the main application (App routes/pages).
...
* [Social Logins](Features-React-Social-Logins)
