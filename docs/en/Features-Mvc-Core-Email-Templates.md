...
- **Template body (HTML)** — A Monaco editor where you can edit the raw HTML body.
...
You can grant or revoke these permissions per role from the [Role Management](Features-Mvc-Core-Role-Management.md) page.

## Next

- [Tenant Dashboard](Features-Mvc-Core-Tenant-Dashboard.md)
