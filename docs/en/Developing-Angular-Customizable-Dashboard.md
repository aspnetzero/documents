...
![Save Page Request](images/customizable-dashboard-angular-savePage.png)

Open the request payload and get the data from there

![Save Page Request Payload](images/customizable-dashboard-angular-savepage-request-payload.png)
