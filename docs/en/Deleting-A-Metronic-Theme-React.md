...
* Go to **src-> app -> shared -> layout** folder
  ...
  * Go to **theme-selection** folder. Open `theme-selection-panel.tsx` and delete Theme2 code parts.
...
* Go to **src -> app -> admin** folder
  ...
  * Go to **ui-customization** folder
    * Delete `theme2-theme-ui-settings.tsx`.
    * Delete `theme2-theme-ui-settings.tsx`.
    * Open `ui-customization.tsx` and delete Theme2 code parts.

* Go to **src -> app** . Open `app module.ts` and delete Theme2 code parts.

* Go to **src -> app**. Open `app.tsx` and delete Theme2 code parts.
