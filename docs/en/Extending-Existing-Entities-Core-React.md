...
Note: The UI part of this document is written for ASP.NET Core React version of ASP.NET Zero. For ASP.NET Core MVC & jQuery version, see  [related doc](Extending-Existing-Entities-Core.md) .
