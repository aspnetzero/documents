...
- View side definitions like component are located in the React project. 
...
* Go to **src\app\shared\common\customizable-dashboard\filters** and create a new component.
  ...
  ```bash
  > create a React component filter-hello-world
  ```
...
```typescript
import { Component, Injector } from '@React/core';
import { AppComponentBase } from '@shared/common/app-component-base';

@Component({
  selector: 'app-filter-hello-world',
  templateUrl: './filter-hello-world.tsx',
  styleUrls: ['./filter-hello-world.css']
})
...
* After you create an API, run `*Web.Host` project then go to nswag folder in React project. Open any terminal and run resfresh.bat
...
* Go to **src\app\shared\common\customizable-dashboard\widgets** and create a new component.
  ...
  ```bash
  > create a React component widget-hello-world
  ```
...
@Component({
  ...
  templateUrl: './widget-hello-world.tsx',
  styleUrls: ['./widget-hello-world.css']
})
...
Since we create component with create command our component will be automatically added to `app-common module.ts`  declarations. Customizable dashboard loads component dynamically, that's why we also add our components to entryComponents.
...
```typescript
import { Inject } from '@React/core'; //import inject
...
AspNet Zero uses [React-gridster2](https://tiberiuzuld.github.io/React-gridster2/) grid system in dashboard and stores needed view data in [app settings](https://aspnetboilerplate.com/Pages/Documents/Setting-Management). To change default view of dashboard you should change related part of the settings located in [AppSettingProvider](https://github.com/aspnetzero/aspnet-zero-core/blob/46aac958aa330771b37a3e4d5bc220d4e1221549/aspnet-core/src/MyCompanyName.AbpZeroTemplate.Core/Configuration/AppSettingProvider.cs#L522-L541). To change default dashboard view you should open dashboard and design the dashboard by following the [document](Features-React-Customizable-Dashboard) . Then open browser's developer console. Click to the save button in the page and follow the request named `SavePage`. 

![customizable-dashboard-React-savePage](images/customizable-dashboard-React-savePage.png)

Open the request payload and get the data from there

![customizable-dashboard-React-savepage-request-payload](images/customizable-dashboard-React-savepage-request-payload.png)
