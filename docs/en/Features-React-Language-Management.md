...
If you want to add a new language, you can review the documentation on [How to Add a New Language in an ASP.NET Zero React Application](Adding-New-Localization-React)
...
- [Audit Logs](Features-React-Audit-Logs)
