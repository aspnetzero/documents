...
![Client Server Folders](images/react-solution-folders.png)

-   **react** folder contains the React UI application which is configured to work with the [Vite](https://vite.dev/).
...
![React Login Page](images/login-screen-3.png)
...
<img src="images/dashboardV1-react.jpg" alt="Dashboard" class="img-thumbnail" />
